...
from betel.models import Hospede, Fator_de_Risco_Social, Familiar, Anotacao_de_Enfermagem, Sinais_Vitais, Controle_de_Dextro, Evolucao, Medicacao, Prescricao, Equipe, Enfermidade, Ficha_de_Avaliacao
...
class HospedeAdmin(admin.ModelAdmin): 
    ...
    inlines = [FamiliarInline, PrescricaoInline, Ficha_de_AvaliacaoInline]
